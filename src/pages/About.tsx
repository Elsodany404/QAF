      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center text-white">
          <div className="inline-block px-4 py-2 rounded-full bg-gold-500/20 border border-gold-500/40 mb-6">
            <p className="text-gold-400 text-xs font-bold tracking-[0.15em] uppercase">
              Our Journey
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4 animate-fade-scale">
              <img
                ...
                alt="Coffee"
                className="rounded-2xl w-full aspect-square object-cover shadow-soft-lg"
              />
              <img
                src="https://images.pexels.com/photos/1695052/pexels-photo-1695052.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Beans"
                className="rounded-2xl w-full aspect-square object-cover shadow-soft-lg mt-8"
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            <div className="inline-block px-4 py-2 rounded-full bg-gold-500/10 border border-gold-500/20 mb-4">
              <p className="text-gold-600 text-xs font-bold tracking-[0.15em] uppercase">
                Values
              </p>
            </div>
            <h2 className="font-display text-5xl font-bold text-charcoal-950">
              What Drives Us
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div
                  className={`w-14 h-14 rounded-full bg-gradient-to-br ${color} flex items-center justify-center mb-5 group-hover:scale-110 transition-transform`}
                >
                  <Icon className="w-7 h-7 text-white" />
                </div>
                <h3 className="font-display font-bold text-charcoal-950 mb-3 text-lg">
                  {title}
                </h3>
            ...
            {[
              ...
              >
                <div className="premium-card p-8 h-full hover:shadow-soft-xl transition-all">
                  <div className="text-5xl font-display font-bold text-gold-500/30 mb-3">
                    {item.step}
                  </div>
